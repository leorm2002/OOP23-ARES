...
/**
 * HandlerAdapter is a class that adapts a Runnable to an EventHandler<ActionEvent>
 */
public class HandlerAdapter implements EventHandler<ActionEvent> {
     ...
     * @param method is a Runnable that will be adapted to an EventHandler<ActionEvent>
     */
    public HandlerAdapter(Runnable method) {
        this.method = method;
    }
