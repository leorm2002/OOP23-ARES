...
public final class FireAgentFactory implements AgentFactory {
    ...
    private void spreadFire(final State state, final Pos pos, final Agent fireAgent) {
        ...
        /* Starts a new fire */
        final Agent newAgent = parametrizzaFireAgent(createAgent(), spread, newFuel, newCons);
     ...
     */
    private Agent parametrizzaFireAgent(final Agent fireAgent, final Integer spread, final Double fuel,
            final Double cons) {
